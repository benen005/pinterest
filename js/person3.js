...
KISSY.ready(function(S){
	...
	//自己页面的 描述输入框
				...
				/**备注 **/
			Event.delegate(document, 'click','.J_UserRemark', function(ev){
				//debugger;
				var that = ev.target, 
					remarkContainer = DOM.next(that);
			...
			Event.delegate(document, 'focusout','.J_Remark', function(ev){
				//debugger;
				var that = ev.target,
					remark = DOM.prev(that);
