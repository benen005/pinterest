...
KISSY.add('gallery/suggest/1.0/index', function (S, DOM, Event, undefined) {
    ...
    S.augment(Suggest, EventTarget, {
        ...
        _initStyle:function () {
            ...
            DOM.addStyleSheet(
                '.ks-suggest-container{background:white;border:1px solid #deddde;z-index:99999}'
                    + '.ks-suggest-shim{z-index:99998}'
                    + '.ks-suggest-container li{border-left:1px solid #fff; border-right:1px solid #fff; color:#aaa;padding:1px 0 2px;font-size:12px;line-height:18px;float:left;width:192px;}'
                    + '.ks-suggest-container .ks-selected{background-color:#21ba8a;cursor:default; color:#fff;}'
