...
<html lang="en-US">
        ...
        <div class="release-container ks-clear">
            ...
            <input type="hidden" name="user_id" id="user_id" value="1" />
                ...
                <div class="ks-clear release-hd">
                    <a href="release5.php" target="_self" >单个网址</a>
                    <a href="release6.php" target="_self" class="selected">多个网址</a>
                </div>
                ...
                <div class="title ks-clear">
                    ...
                    <div class="title-box ks-clear">
                        ...
                        <textarea cols="113" rows="5" name="photo2" id="photo2"></textarea>
                    </div>
                </div>
    ...
    <script src="js/release6.js"></script>
</body>
</html>
